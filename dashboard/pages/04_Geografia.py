...
k2.metric("Top 5 = % iscritti", fmt_pct(top5["totale"].sum() / df["totale"].sum() * 100, signed=False))
k3.metric("Top 10 = % iscritti", fmt_pct(top10["totale"].sum() / df["totale"].sum() * 100, signed=False))
