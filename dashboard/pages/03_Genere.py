...
k2.metric("% Donne nazionale", f"{pct_donne_naz:.1f}%")
k3.metric("Classi STEM / non-STEM", f"{df[df['area_stem'] == 'STEM']['classe_cod'].nunique()} / {df[df['area_stem'] != 'STEM']['classe_cod'].nunique()}")
